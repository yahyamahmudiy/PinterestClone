...
class HomeFragmentNature : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view:View = inflater.inflate(R.layout.fragment_home_nature, container, false)
    ...
    fun apiPosterListRetrofit(){
        RetrofitHttp.posterService.listPhotosNature().enqueue(object :
