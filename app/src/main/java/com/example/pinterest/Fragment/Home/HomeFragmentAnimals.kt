...
class HomeFragmentAnimals : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view:View = inflater.inflate(R.layout.fragment_home_animals, container, false)
    ...
    fun apiPosterListRetrofit(){
        RetrofitHttp.posterService.listPhotosAnimals().enqueue(object : Callback<ArrayList<ResponseItem>> {
